      ...
      <Container maxWidth={themeStretch ? false : 'xl'}>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={3}>
            <AnalyticsWidgetSummary title="Growers" total={numOfGrowers} icon={'ant-design:android-filled'} />
          </Grid>

          <Grid item xs={12} sm={6} md={3}>
            <AnalyticsWidgetSummary title="Trees" total={numOfTrees} color="info" icon={'ant-design:apple-filled'} />
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <AnalyticsWidgetSummary title="Locations" total={numOfUsers} color="error" icon={'ant-design:bug-filled'} />
          </Grid>
