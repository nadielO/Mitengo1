...
export const PATH_DASHBOARD = {
  ...
  trees: {
    root: path(ROOTS_DASHBOARD, '/trees'),
    shop: path(ROOTS_DASHBOARD, '/trees/shop'),
    list: path(ROOTS_DASHBOARD, '/trees/list'),
    checkout: path(ROOTS_DASHBOARD, '/e-commerce/checkout'),
    new: path(ROOTS_DASHBOARD, '/trees/product/new'),
    view: (name) => path(ROOTS_DASHBOARD, `/trees/product/${name}`),
    edit: (name) => path(ROOTS_DASHBOARD, `/trees/product/${name}/edit`),
  ...
  locations: {
    ...
    new: path(ROOTS_DASHBOARD, '/tree/new'),
    view: (id) => path(ROOTS_DASHBOARD, `/invoice/${id}`),
    edit: (id) => path(ROOTS_DASHBOARD, `/invoice/${id}/edit`),
    editLocation: (id) => path(ROOTS_DASHBOARD, `/location/${id}/edit`),
