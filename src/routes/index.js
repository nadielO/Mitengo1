...
const EcommerceProductListCopy = Loadable(lazy(() => import('../pages/dashboard/EcommerceProductListCopy')));
...
const InvoiceEditCopy = Loadable(lazy(() => import('../pages/dashboard/InvoiceEditCopy')));
...
const sales = Loadable(lazy(() => import('../pages/dashboard/Kanban')));
