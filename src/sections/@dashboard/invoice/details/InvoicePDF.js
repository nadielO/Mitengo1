      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>{buyerName}</Text>
          ...
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>{growerName}</Text>
            <Text style={styles.body1}>{}</Text>
            <Text style={styles.body1}>{growersNumber}</Text>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableBody}>
              ...
              <View style={styles.tableRow}>
                ...
                <View style={styles.tableCell_2}>
                  <Text style={styles.subtitle2}>{treeName}</Text>
                  <Text>{status}</Text>
                </View>

                <View style={styles.tableCell_3}>
                  <Text>{treeQuantity}</Text>
                </View>
